...
void Audio_SetMute(uint32_t Cmd)
{
	...
	{
		WriteRegister(CS43L22_REG_POWER_CTL2, 0xFF);
		WriteRegister(CS43L22_REG_HEADPHONE_A_VOL, 0x01);
		WriteRegister(CS43L22_REG_HEADPHONE_B_VOL, 0x01);
	}
	else /* AUDIO_MUTE_OFF Disable the Mute */
	{
		WriteRegister(CS43L22_REG_HEADPHONE_A_VOL, 0x00);
		WriteRegister(CS43L22_REG_HEADPHONE_B_VOL, 0x00);
		WriteRegister(CS43L22_REG_POWER_CTL2, OUTPUT_DEVICE_AUTO);
	}
}
